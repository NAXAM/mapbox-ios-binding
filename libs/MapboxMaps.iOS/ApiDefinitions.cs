...
namespace MapboxMaps
{
  ...
  be used.
*/
    partial interface ILocationConsumer { }
    ...
    partial interface ILocationPermissionsDelegate {}
...
*/
    ...
    interface MapView
    {
        ...
        // -(instancetype _Nullable)init:(CoreGraphics.CGRect * _Nonnull)frame, mapInitOptions: MapboxMaps.MapInitOptions;
        [Export("init:mapInitOptions:")]
        IntPtr Constructor(CoreGraphics.CGRect frame, MapInitOptions mapInitOptions);
